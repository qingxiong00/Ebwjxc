...
*--
#Define BLACKNESS		0x42		&& 全部为 0
#Define DSTINVERT		0x550009	&& not 目标像素
#Define MERGECOPY		0xC000CA	&& 画刷 and 源像素
#Define MERGEPAINT		0xBB0226	&& (not 源像素) or 目标像素
#Define NOTSRCCOPY		0x330008	&& not 源像素
#Define NOTSRCERASE		0x1100A6	&& not (源像素 or 目标像素)
#Define PATCOPY			0xF00021	&& 画刷
#Define PATINVERT		0x5A0049	&& 画刷 xor 目标像素
#Define PATPAINT		0xFB0A09	&& 画刷 or (not 源像素) or 目标像素
#Define SRCAND			0x8800C6	&& 源像素 and 目标像素
#Define SRCCOPY			0xCC0020	&& 源像素
#Define SRCERASE		0x440328	&& 源像素 and (not 目标像素)
#Define SRCINVERT		0x660046	&& 源像素 xor 目标像素
#Define SRCPAINT		0xEE0086	&& 源像素 or 目标像素
#Define WHITENESS		0xFF0062	&& 全部为 1
...
*--
#Define NIM_ADD 			0		&& 添加图标信息到系统托盘
#Define NIM_MODIFY 			0x01	&& 修改系统托盘中的图标信息
#Define NIM_DELETE 			0x02	&& 删除系统托盘中的图标信息
...
*--
#Define NIF_MESSAGE			0x01	&& 托盘信息
#Define NIF_ICON 			0x02	&& 托盘信息带图标
#Define NIF_TIP 			0x04 	&& 托盘信息带 ToolTipTest
#Define NIF_STATE       	0x08
#Define NIF_INFO 			0x10	&& 新增托盘图标后，弹出气泡提示
#define NIF_GUID 			0x20

*-- 	dwState to NOTIFYICONDATA
#Define NIS_HIDDEN			0x01	&& 图标隐藏
#Define NIS_SHAREDICON		0x02	&& 图标共享

*--
*-- 	uTimeoutAndVersion to NOTIFYICONDATA 
*--
#Define NOTIFYICON_OLDVERSION 	0x00 	&& Win95 任务栏样式
#Define NOTIFYICON_VERSION 		0x03 	&& Win32 任务栏样式

*--
*-- 	dwInfoFlags to NOTIFYICONDATA 
*--
#Define NIIF_NONE 				0x00	&& 无气泡
#Define NIIF_INFO 				0x01	&& 信息图标
#Define NIIF_WARNING 			0x02	&& 警告图标
#Define NIIF_ERROR 				0x03	&& 错误图标
#Define NIIF_EXEICON 			0x04	&& EXE 文件中的图标 (如 IDE 状态取 lpData 中的图标)
#Define NIIF_GUID 				0x05	&& 托盘图标
#Define NIIF_ICON_MASK 			0x0F	
#Define NIIF_NOSOUND 			0x10	&& 提示弹出无声音
...
*--
#Define BIF_RETURNONLYFSDIRS 	0x01		&& 只有当用户选中的是文件夹时"确定"按钮才有效
#Define BIF_DONTGOBELOWDOMAIN 	0x02		&& 
#Define BIF_STATUSTEXT 			0x04		&& 界面上包含一块statu区域, 回调函数通过向对话框发送消息
&& #Define BFFM_SETSTATUSTEX	????		&& 消息设置静态文本
#Define BIF_RETURNFSANCESTORS 	0x08
#Define BIF_EDITBOX 			0x10		&& 对话框上显示一个Edit,允许用户输入选中项的名称
#Define BIF_VALIDATE 			0x20		&& 当用户在Edit中输入不正确的名字时,向对话框发送消息
#Define BIF_USENEWUI 			0x40		&& 新的界面
#Define BIF_NEWDIALOGSTYLE 		0x40		&& 
#Define BIF_BROWSEINCLUDEURLS 	0x80
#Define BIF_BROWSEFORCOMPUTER 	0x1000		&& 只有选中"我的电脑"时"确定"按钮才有效
